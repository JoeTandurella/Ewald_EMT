---
title: "CoGAPS Visuals -- TGF_BETA_SIGNALING Barplots"
author: "Joe"
date: "7/12/2021"
...
result <- fora(pathways = hallmark_list,
                   ...
                   maxSize=2038)
resultfiltered_P10[i,] <- result[result$pathway=="HALLMARK_TGF_BETA_SIGNALING",]
}
...
result <- fora(pathways = hallmark_list,
                   ...
                   universe = unique(Mm_genes$mgi_symbol),
                   maxSize=2038)
resultfiltered_P12[i,] <- result[result$pathway=="HALLMARK_TGF_BETA_SIGNALING",]
}
...
result <- fora(pathways = hallmark_list,
                   ...
                   universe = unique(Mm_genes$mgi_symbol),
                   maxSize=2038)
resultfiltered_P14[i,] <- result[result$pathway=="HALLMARK_TGF_BETA_SIGNALING",]
}
...
result <- fora(pathways = hallmark_list,
                   ...
                   universe = unique(Mm_genes$mgi_symbol),
                   maxSize=2038)
resultfiltered_P16[i,] <- result[result$pathway=="HALLMARK_TGF_BETA_SIGNALING",]
}
...
result <- fora(pathways = hallmark_list,
                   ...
                   universe = unique(Mm_genes$mgi_symbol),
                   maxSize=2038)
resultfiltered_P20[i,] <- result[result$pathway=="HALLMARK_TGF_BETA_SIGNALING",]
}
...
result <- fora(pathways = hallmark_list,
                   ...
                   universe = unique(Mm_genes$mgi_symbol),
                   maxSize=2038)
resultfiltered_P25[i,] <- result[result$pathway=="HALLMARK_TGF_BETA_SIGNALING",]
}
...
##save results
save(resultfiltered_P10,resultfiltered_P12,resultfiltered_P14,resultfiltered_P16,resultfiltered_P20,resultfiltered_P25, file="Cogaps/Whole/TGFB_Hallmark_results.rda")
```

##Barplot of -10*log10 for TGF_BETA_SIGNALING pathway
```{r}
...
##save as pdf
pdf(file="Cogaps/Whole/Figures/TGFB_Pathway_Barplots.pdf")
...
print(get(resultsFiles[i]) %>% 
    ...
    theme_minimal() +
    ## Add title
    ggtitle(paste0("Hallmark TGFB Pathway (", nPatterns[i], ")")) +
