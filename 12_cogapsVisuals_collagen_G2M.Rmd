---
title: "CoGAPS Visuals -- G2M Barplots"
author: "Joe"
date: "7/12/2021"
...
result <- fora(pathways = hallmark_list,
                   ...
                   maxSize=2038)
resultfiltered_P10[i,] <- result[result$pathway=="HALLMARK_G2M_CHECKPOINT",]
}
...
result <- fora(pathways = hallmark_list,
                   ...
                   universe = unique(Mm_genes$mgi_symbol),
                   maxSize=2038)
resultfiltered_P12[i,] <- result[result$pathway=="HALLMARK_G2M_CHECKPOINT",]
}
...
result <- fora(pathways = hallmark_list,
                   ...
                   universe = unique(Mm_genes$mgi_symbol),
                   maxSize=2038)
resultfiltered_P14[i,] <- result[result$pathway=="HALLMARK_G2M_CHECKPOINT",]
}
...
result <- fora(pathways = hallmark_list,
                   ...
                   universe = unique(Mm_genes$mgi_symbol),
                   maxSize=2038)
resultfiltered_P16[i,] <- result[result$pathway=="HALLMARK_G2M_CHECKPOINT",]
}
...
result <- fora(pathways = hallmark_list,
                   ...
                   universe = unique(Mm_genes$mgi_symbol),
                   maxSize=2038)
resultfiltered_P20[i,] <- result[result$pathway=="HALLMARK_G2M_CHECKPOINT",]
}
...
result <- fora(pathways = hallmark_list,
                   ...
                   universe = unique(Mm_genes$mgi_symbol),
                   maxSize=2038)
resultfiltered_P25[i,] <- result[result$pathway=="HALLMARK_G2M_CHECKPOINT",]
}
...
##save results
save(resultfiltered_P10,resultfiltered_P12,resultfiltered_P14,resultfiltered_P16,resultfiltered_P20,resultfiltered_P25, file="Cogaps/Whole/G2M_Hallmark_results.rda")
```

##Barplot of -10*log10 for G2M pathway
```{r}
...
##save as pdf
pdf(file="Cogaps/Whole/Figures/G2M_Pathway_Barplots.pdf")
...
print(get(resultsFiles[i]) %>% 
    ...
    theme_minimal() +
    ## Add title
    ggtitle(paste0("Hallmark G2M Pathway (", nPatterns[i], ")")) +
